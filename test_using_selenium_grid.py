...
def test_user_reg(driver):
    ...
    time.sleep(2)
    driver.find_element(By.CSS_SELECTOR, 'body > div.page > header > nav > div.d-none.d-xl-block.navbar-header.header_inner.utility_nav > div > div > div > a.user_link.login').click()
    time.sleep(2)
    ...
    driver.find_element(By.ID, "login-email").send_keys("y_tessts_pytest@gmail.com")
    ...
    time.sleep(2)
    driver.find_element(By.CSS_SELECTOR,"#form > div.d-flex.justify-content-center.account-register > div:nth-child(1) > div > div > div.gl-checkbox.gl-form-item--required > label > input").click()
    time.sleep(2)
...
def test_search_product_feature(driver):
    ...
    time.sleep(2)
    driver.find_element(By.XPATH, "//input[contains(@name, 'q')]").click()
    time.sleep(3)
    driver.find_element(By.XPATH, "//input[contains(@name, 'q')]").send_keys(
        "CROP TEE WITH BINDING DETAILS")
    time.sleep(3)
    driver.find_element(By.XPATH, "//input[contains(@name, 'q')]").send_keys(Keys.ENTER)
    time.sleep(3)
